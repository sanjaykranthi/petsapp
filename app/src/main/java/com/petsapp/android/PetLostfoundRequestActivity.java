...
public class PetLostfoundRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_lostfound_request);
        ...
        if (petstate.equalsIgnoreCase("1")) {
            mate.setText("REQUEST FOUND");
            petstate1 = "0";
        } else {
            mate.setText("REQUEST LOST");
            petstate1 = "1";
        }
        ...
        mate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Isinternetpresent) {
                    ...
                    PetLostFoundTask task = new PetLostFoundTask();
                    task.execute("http://petsapp.petsappindia.co.in/pat.asmx/lostandfoundupdatestatus");
                } else {
                    showAlertDialog(PetLostfoundRequestActivity.this, "No Internet Connection", "You don't have internet connection.", false);
                }
            }
        });
    }
    ...
    private class PetLostFoundTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            //  reg();
            super.onPreExecute();
            dialog = ProgressDialog.show(PetLostfoundRequestActivity.this, "Fetching Data",
                    "Please wait...", true);
            dialog.show();
        }
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                urlParameters = "&pid=" + URLEncoder.encode(petmateid, "UTF-8") +
                        "&lfstatus=" + URLEncoder.encode(petstate1, "UTF-8") +
                        "&lfdate=" + URLEncoder.encode(formateDate, "UTF-8");
                url = new URL(urls[0]);
            ...
            try {
                ...
                for (int i = 0; i < arr.length(); i++) {
                    ...
                    if (state.contains("success")) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), AddLostFoundActivity.class);
