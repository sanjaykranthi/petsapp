...
public class AdoptionPetProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adoption_pet_profile);
        ...
        intrest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(AdoptionPetProfile.this);
                dialog.setContentView(R.layout.dialog);
                dialog.getWindow().setTitleColor(getResources().getColor(R.color.adoption_interest));
                    ...
                    public void onClick(View v) {
                        try {
                            if (Isinternetpresent) {
                                ...
                                task.execute("http://petsapp.petsappindia.co.in/pat.asmx/adoptsendsms");
                            } else {
                                showAlertDialog(AdoptionPetProfile.this, "No Internet Connection", "You don't have internet connection.", false);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
    ...
    private class AdoptioninterestTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = ProgressDialog.show(AdoptionPetProfile.this, "Fetching Data",
                    "Please wait...", true);
            dialog.show();
        }
