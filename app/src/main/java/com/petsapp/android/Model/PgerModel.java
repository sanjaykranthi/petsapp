 ...
 */
public class PgerModel {

    private String name, age, gender, breed, category, weight, height, size, vac, crsbrdreqd, about, pstate, lat, lon, phone;
    private String photo, petmateid, textname;
