...
public class AddAdoptionActivity extends AppCompatActivity {
    ...
    public static String ADOPTSTATE = "ADOPTSTATE";
    public static String PETMATEID = "PETMATEID";
    public static String IMAGES = "IMAGES";
    public static String TEXTNAME = "TEXTNAME";
    ...
    String formateDate;
    String petid1 = "", pstate1 = "";
    TextView nodataaddadoption;
    RecyclerView rview;
    List<AdoptRequestModel> donorlist;
    ArrayList<HashMap<String, String>> fillMaps = null;
    HashMap<String, String> map = null;
    RegAdoptionpetsListAdapter adapter;
    ListView lview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lview = (ListView) findViewById(R.id.listviewde);
        rview = (RecyclerView) findViewById(R.id.recycle2);


        nodataaddadoption = (TextView) findViewById(R.id.nodataaddadoption);
        nodataaddadoption.setVisibility(View.GONE);

        cd = new ConnectionDetector(getApplicationContext());
        Isinternetpresent = cd.isConnectingToInternet();
        if (Isinternetpresent) {
            donorlist = CommonUtilities.adoptionreglist;
            ...
            if (donorlist.size() > 0) {
                for (int i = 0; i < donorlist.size(); i++) {
                    ...
                    if (donorlist.get(i).getbreed() != null) {
                        ...
                        map.put(ADOPTSTATE, donorlist.get(i).pstate);
                        map.put(PETMATEID, donorlist.get(i).petmateid);
                        map.put(IMAGES, donorlist.get(i).photo);
                        map.put(TEXTNAME, donorlist.get(i).textname);
                        fillMaps.add(map);
            ...
            adapter = new RegAdoptionpetsListAdapter(this, fillMaps, R.layout.customlist, new String[]{}, new int[]{});
            lview.setAdapter(adapter);


        } else {
            showAlertDialog(AddAdoptionActivity.this, "No Internet Connection", "You don't have internet connection.", false);
        }
        ...
        petRegButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), AdoptionPetRegActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onBackPressed() {
        Intent i = new Intent(AddAdoptionActivity.this, AdoptionActivity.class);
        i.setFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
        finish();
    ...
    public class RegAdoptionpetsListAdapter extends ArrayAdapter<HashMap<String, String>> {
        ...
        public RegAdoptionpetsListAdapter(Context context, ArrayList<HashMap<String, String>> fillMaps, int layout, String[] from, int[] to) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.right = (Button) convertView.findViewById(R.id.right1);
                holder.remove = (Button) convertView.findViewById(R.id.remove1);
            ...
            if (currentData != null) {
                ...
                holder.pstate.setText(currentData.get(ADOPTSTATE));
              ...
              /*  petmid = holder.petmateid.getText().toString();
                stateval = holder.pstate.getText().toString();*/

                if (state1.equalsIgnoreCase("0")) {

                    holder.right.setBackgroundResource(R.drawable.done_img);
                    holder.remove.setBackgroundResource(R.drawable.adpt_rmv_clr);
                    holder.right.setEnabled(true);
                    holder.remove.setEnabled(false);

                }
                if (state1.equalsIgnoreCase("1")) {
                    holder.right.setBackgroundResource(R.drawable.adpt_done_clr);
        ...
        public void showAddDialog(String statev, String msg) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(AddAdoptionActivity.this);
            builder.setMessage(msg)
                    .setCancelable(false)
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {

                            new PetRegisterTask().execute("http://petsapp.petsappindia.co.in/pat.asmx/adoptionstateupdate");
                            Intent intent = new Intent(getApplicationContext(), FindAdoptActivity.class);
        ...
        private class PetRegisterTask extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... urls) {
                ...
                try {
                    urlParameters = "&pid=" + URLEncoder.encode(petmid, "UTF-8") +
                            "&state=" + URLEncoder.encode(statev, "UTF-8") +
    ...
    public class MateAddTask extends AsyncTask<String, String, List<AdoptRequestModel>> {
        ...
        @Override
        protected List<AdoptRequestModel> doInBackground(String... urls) {
...
//
        ...
        @Override
        protected void onPostExecute(List<AdoptRequestModel> itemObjects) {
            super.onPostExecute(itemObjects);
            //   ServiceAdapter adapter = new ServiceAdapter(getApplicationContext(), R.layout.spinner_row, result);
            //
            if (itemObjects != null && itemObjects.size() > 0) {
                ...
                PetAdoptAdapter adapter = new PetAdoptAdapter(getApplicationContext(), itemObjects);
                rview.setAdapter(adapter);

                //  dialog.dismiss();
            } else {
                nodataaddadoption.setVisibility(View.VISIBLE);
                rview.setVisibility(View.GONE);
     ...
     * Adapter
     ****/
    public class PetAdoptAdapter extends RecyclerView.Adapter<PetAdoptAdapter.ViewHolder> {
        public static final String MyPREFERENCES = "AdoptPrefs";
        Button mate, remove;
        JSONArray arr = null;
        String stateval, userid, petmid;
        private List<AdoptRequestModel> itemList;
        ...
        public PetAdoptAdapter(Context context, List<AdoptRequestModel> itemList) {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View layoutview = LayoutInflater.from(parent.getContext()).inflate(R.layout.adopt_request_view, null);
        ...
        public AdoptRequestModel getItem(int pos) {
    ...
    public class GetMembersAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            //  reg();
            super.onPreExecute();
            dialog = ProgressDialog.show(AddAdoptionActivity.this, "Loading",
                    "Please wait...", true);
            dialog.show();
        }
