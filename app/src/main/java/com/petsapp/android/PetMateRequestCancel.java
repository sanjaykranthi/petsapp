...
public class PetMateRequestCancel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_mate_request_cancel);
        ...
        imagl = (ImageView) findViewById(R.id.imgs2);
        ...
        cancelrequest = (Button) findViewById(R.id.cancerequest);
        ...
        cancelrequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Isinternetpresent) {
                    ...
                    task.execute("http://petsapp.petsappindia.co.in/pat.asmx/stateupdate");
                } else {
                    showAlertDialog(PetMateRequestCancel.this, "No Internet Connection", "You don't have internet connection.", false);
                }
    ...
    private class PetRegisterTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            dialog = ProgressDialog.show(PetMateRequestCancel.this, "Fetching Data",
                    "Please wait...", true);
            dialog.show();
        }
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                urlParameters = "&petmateid=" + URLEncoder.encode(petmateid, "UTF-8") +
                        "&st=" + URLEncoder.encode(petstate, "UTF-8");
                url = new URL(urls[0]);
            ...
            try {
                ...
                for (int i = 0; i < arr.length(); i++) {
                    ...
                    if (state.contains("success")) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), AddPetMateActivity.class);
