...
public class PetMateRequest extends AppCompatActivity {
    Button mate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pet_mate_request);
        ...
        mate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Isinternetpresent) {
                    ...
                    showAlertDialog(PetMateRequest.this, "No Internet Connection", "You don't have internet connection.", false);
                }
            }
        });
    }
    ...
    private class PetRegisterTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            //  reg();
            super.onPreExecute();
            dialog = ProgressDialog.show(PetMateRequest.this, "Fetching Data",
                    "Please wait...", true);
            dialog.show();
        }
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                urlParameters = "&petmateid=" + URLEncoder.encode(petmateid, "UTF-8") +
                        "&st=" + URLEncoder.encode(petstate1, "UTF-8") +
